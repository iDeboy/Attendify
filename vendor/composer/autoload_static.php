...
class ComposerStaticInitce3966ebaadba5ec21f10f5c5255e2ff
{
    ...
    public static $prefixDirsPsr4 = array (
        ...
        'Abstractions\\' => 
        array (
            0 => __DIR__ . '/../..' . '/Abstractions',
        ),
    );

    public static $classMap = array (
        'Abstractions\\DbContext' => __DIR__ . '/../..' . '/Abstractions/DbContext.php',
        'Abstractions\\Host' => __DIR__ . '/../..' . '/Abstractions/Host.php',
        'Abstractions\\HostBuilder' => __DIR__ . '/../..' . '/Abstractions/HostBuilder.php',
        'Abstractions\\HttpClient' => __DIR__ . '/../..' . '/Abstractions/HttpClient.php',
        'Abstractions\\Renderer' => __DIR__ . '/../..' . '/Abstractions/Renderer.php',
        'Abstractions\\Router' => __DIR__ . '/../..' . '/Abstractions/Router.php',
        'Attribute' => __DIR__ . '/..' . '/symfony/polyfill-php80/Resources/stubs/Attribute.php',
        'Composer\\InstalledVersions' => __DIR__ . '/..' . '/composer/InstalledVersions.php',
        'Controllers\\LoginController' => __DIR__ . '/../..' . '/Controllers/LoginController.php',
        'Controllers\\PruebasController' => __DIR__ . '/../..' . '/Controllers/PruebasController.php',
        'Controllers\\RegistroController' => __DIR__ . '/../..' . '/Controllers/RegistroController.php',
        'DependencyInjection\\ConstructorServiceCall' => __DIR__ . '/../..' . '/DependencyInjection/ConstructorServiceCall.php',
        'DependencyInjection\\FactoryServiceCall' => __DIR__ . '/../..' . '/DependencyInjection/FactoryServiceCall.php',
        'DependencyInjection\\IServiceProvider' => __DIR__ . '/../..' . '/DependencyInjection/IServiceProvider.php',
        'DependencyInjection\\ServiceCall' => __DIR__ . '/../..' . '/DependencyInjection/ServiceCall.php',
        'DependencyInjection\\ServiceCallFactory' => __DIR__ . '/../..' . '/DependencyInjection/ServiceCallFactory.php',
        'DependencyInjection\\ServiceCollection' => __DIR__ . '/../..' . '/DependencyInjection/ServiceCollection.php',
        'DependencyInjection\\ServiceDescriptor' => __DIR__ . '/../..' . '/DependencyInjection/ServiceDescriptor.php',
        'DependencyInjection\\ServiceLifetime' => __DIR__ . '/../..' . '/DependencyInjection/ServiceLifetime.php',
        'DependencyInjection\\ServiceProvider' => __DIR__ . '/../..' . '/DependencyInjection/ServiceProvider.php',
        'DependencyInjection\\ServiceProviderCall' => __DIR__ . '/../..' . '/DependencyInjection/ServiceProviderCall.php',
        'DependencyInjection\\ServiceResolver' => __DIR__ . '/../..' . '/DependencyInjection/ServiceResolver.php',
    ...
    public static function getInitializer(ClassLoader $loader)
    {
        return \Closure::bind(function () use ($loader) {
            $loader->prefixLengthsPsr4 = ComposerStaticInitce3966ebaadba5ec21f10f5c5255e2ff::$prefixLengthsPsr4;
            $loader->prefixDirsPsr4 = ComposerStaticInitce3966ebaadba5ec21f10f5c5255e2ff::$prefixDirsPsr4;
            $loader->classMap = ComposerStaticInitce3966ebaadba5ec21f10f5c5255e2ff::$classMap;
